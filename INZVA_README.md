...
| Env geometry generally | **Unchanged** | Setting the env to a recorded state reproduces the recorded frame: mean absolute difference under 0.5 of 255, 0.38% of pixels differing, all edge antialiasing. `scripts/check_env_matches_dataset.py` |
